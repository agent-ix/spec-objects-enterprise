...
- **Upstream**: [FR-001](./FR-001-module-manifest-activates.md), [FR-002](./FR-002-emitted-json-schemas.md), [FR-004](./FR-004-role-schemas.md) (the relation-verb enums FR-003-AC-7 compares `allowed_links` against; the schema is the authority and the manifest follows it, which is what makes the coupling one-directional); quoin FR-070/FR-073 (`ix://agent-ix/quoin/FR-070`, `ix://agent-ix/quoin/FR-073`); quire-rs FR-069 (`ix://agent-ix/quire-rs/FR-069`)
